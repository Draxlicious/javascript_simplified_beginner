...
const cardItemsWrapper = document.querySelector("[data-cart-items-wrapper]")
let shoppingCart = []
...
export function setupShoppingCart(){
    ...
    cartButton.addEventListener("click", function(){
        cardItemsWrapper.classList.toggle("invisible")
    })
}
...
function hideCart(){
    ...
    cardItemsWrapper.classList.add("invisible")
}
